...
<body>
  ...
  <div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="inc/additem_check.php">
      <div class="mb-3">
        <label for="imgname" class="form-label">Image Name</label>
        <input type="text" class="form-control" id="imgname" name="product_name" required>
      </div>

      <div class="mb-3">
        <label for="imgcategory" class="form-label">Image Category</label>
        <input type="text" class="form-control" id="imgcategory" name="category" required>
      </div>

      <div class="mb-3">
        <label for="imgprice" class="form-label">Image Price</label>
        <input type="number" class="form-control" id="imgprice" name="price" required>
      </div>
      ...
      <br>
      <button type="submit" class="btn btn-success" name="addimage"><i class="fa fa-cloud-upload"></i> Add</button>
    </form>
